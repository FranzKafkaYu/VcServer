...
object AboutScreenConstants {
	 ...
	 * Github主页
	*/
    const val GITHUB_PROFILE = "https://github.com/FranzKafkaYu"
	/**
	 * GitHub 仓库地址
	 */
			...
			Card(
				...
				Column(
					...
					InfoRow(
						...
						value = AboutScreenConstants.AUTHOR,
						onValueClick = {
							val intent = Intent(Intent.ACTION_VIEW, Uri.parse(AboutScreenConstants.GITHUB_PROFILE))
